...
#[inline]
fn depend(graph: &mut Graph, src: usize, dest: usize) {
...
pub fn min_func(
    ...
    add_formula(g, dst as usize, start, end, 9, farr);
...
pub fn max_func(
    ...
    add_formula(g, dst as usize, start, end, 10, farr);
...
pub fn avg_func(
    ...
    add_formula(g, dst as usize, start, end, 11, farr);
...
pub fn sum_func(
    ...
    add_formula(g, dst as usize, start, end, 12, farr);
...
pub fn standard_dev_func(
    ...
    add_formula(g, dst as usize, start, end, 13, farr);
